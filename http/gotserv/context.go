...
func (o *HTTPContext) ResponseHeaderSet(key, value string) {
	o.Writer.Header().Set(key, value)
}

//ResponseHeaderAdd 追加返回头
func (o *HTTPContext) ResponseHeaderAdd(key, value string) {
	o.Writer.Header().Set(key, value)
}

//DecodeRequestBodyAsJSON 把请求内容解析为 json
func (o *HTTPContext) DecodeRequestBodyAsJSON(v interface{}) error {
